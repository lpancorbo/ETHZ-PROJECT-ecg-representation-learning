...
for ind, name in enumerate(names):
    ...
    encoder.load_state_dict(torch.load(os.path.join('models', f'{name}_best_parameters.pth')))
    classifier.load_state_dict(torch.load(os.path.join('models', f'{name}_best_classifier.pth')))
