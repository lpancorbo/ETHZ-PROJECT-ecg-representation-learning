...
from src.data.MyDataset import CustomTimeSeriesDataset, weighted_sampler_dataloader
...
from src.models.model_zoo import simpleCNN, simpleLSTM, BiLSTM, ResCNN, TransformerWithAttentionOutputted
...
if continue_training:
    ...
    checkpoint = torch.load(os.path.join('models', f'{name}_scheduler_optimizer_state.pth'))
